...
avocados <- rename(avocados, small_haas = X4046, large_haas = X4225, xlarge_haas = X4770)
...
# the `spread()` function!
by_type_wide <- spread(by_type, key = type, value = total_volume)
